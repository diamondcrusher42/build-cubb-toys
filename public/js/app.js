...
/* harmony import */ var _invest__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./invest */ "./resources/js/invest.js");
/* harmony import */ var _invest__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_invest__WEBPACK_IMPORTED_MODULE_4__);
...
(0,_carousel_slider__WEBPACK_IMPORTED_MODULE_0__.createSlider3D)('.carousel-slider');
(0,_carousel_slider__WEBPACK_IMPORTED_MODULE_0__.createSlider)('.project-slider');
var projectCountDownEl = document.getElementById('project-count-down');

if (projectCountDownEl) {
  _pqina_flip__WEBPACK_IMPORTED_MODULE_1__["default"].DOM.create(projectCountDownEl, {
    didInit: function didInit(tick) {
      var counter = _pqina_flip__WEBPACK_IMPORTED_MODULE_1__["default"].count.down(projectCountDownEl.dataset.date, {
        format: ['d', 'h', 'm', 's']
      });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createSlider3D": () => (/* binding */ createSlider3D),
...
function createSlider3D(selector) {
  var swiperEl = document.querySelector(selector + ' .swiper');

  if (!swiperEl) {
    return;
  }

  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperEl, {
    ...
    on: {
      progress: function progress(swiper) {
        ...
        var _loop = function _loop(i) {
          ...
          var translate = "".concat(slideProgress * modify * 40, "%");
...
if (project) {
  (function () {
    var projectId = project.dataset.id;
    var tiers = project.querySelectorAll('.support-project .support-tiers .tier');
    ...
    var _loop = function _loop(i) {
      ...
      tier.querySelector('.invest-button').addEventListener('click', function () {
        var amount = tier.dataset.amount;
        document.body.classList.add('popup-open');
        var nf = new Intl.NumberFormat('sl-SI');
...
var currentImage = document.querySelector('main#project .current-image.swiper');
var fullScreen = document.querySelector('main#project .full-screen-swiper-wrap');
var thumbnails = document.querySelector('main#project .thumbnails.swiper');
...
if (currentImage) {
  ...
  var currentImageSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](currentImage, {
    loop: loop,
    spaceBetween: 20,
    thumbs: {
  ...
  if (fullScreen) {
    ...
    var fullScreenSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.full-screen-swiper-wrap .swiper', {
      loop: loop,
      navigation: {
